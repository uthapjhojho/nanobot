...
# === Local channel configs (preserved for backward compatibility) ===
...
class ChannelsConfig(Base):
    ...
    # Preserve local channel configs as optional fields
...
class AgentDefaults(Base):
    ...
    # Preserve local fields for backward compatibility
    memory_window: int = 50  # Local: legacy field name
